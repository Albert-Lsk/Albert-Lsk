...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/语言-简体中文-red?style=for-the-badge" alt="简体中文">
</p>
...
My career has been a journey of 'cross-disciplinary growth'—from the systematic thinking of a **Marine Engineer** to the user-centric mindset of a **Product Manager**, and now, I'm all-in on **AI**. This unique path has given me a deep appreciation for the power of the right tools. I believe the best technology should feel like a superpower, and my mission is to help you find, master, and "tame" it.
...
![Cross--disciplinary Collaboration](https://img.shields.io/badge/Cross--disciplinary-FF69B4?style=for-the-badge)
...
-   👯 I’m looking to collaborate on projects involving the integration of **AI with RPA and No-code/Low-code platforms**.
-   🤔 Feel free to reach out for a chat about **designing AI-powered workflows** or choosing the right no-code stack for your project.
...
### 🤝 期待与你连接 (Let's Connect)

-   👯 我正在寻找对 **RPA、No-code 与 AI 结合的自动化解决方案** 感兴趣的同路人，一起创造有趣的项目！
-   🤔 如果你在 **AI 工作流搭建** 或 **无代码平台应用** 上遇到难题，欢迎随时找我交流。
